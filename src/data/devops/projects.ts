...
export const selectedProjects: ProjectEvidence[] = [
  ...
  },
  {
    ...
    system: "A rebuilt ghOSt-enabled Linux environment comparing kernel-only CFS/FIFO paths with user-space scheduling policies on RocksDB.",
    contribution: "Built and configured the ghOSt kernel environment, structured the RocksDB experiment matrix, and analyzed scheduler behavior without asserting unsupported benchmark winners.",
    outcome: "Completed systems-performance project with a browser policy-flow lab; a canonical public repository link has not been verified.",
    ownership: "coursework",
    status: "completed-coursework",
    domain: ["Operating systems", "Performance", "Experiment design"],
    stack: ["Linux", "ghOSt", "C/C++", "RocksDB"],
    links: [{ kind: "demo", label: "Demo", href: "/demos#ghost" }],
    whyItMatters: "Platform work improves when performance claims come from reproducible experiments and controlled variables.",
    evidenceId: "ghost",
    verificationNotes: ["No canonical public repository is verified; the linked lab is a labeled browser simulation."],
  },
  {
...
export const completeWork: ProjectEvidence[] = [
  ...
  },
  {
    ...
    contribution: "The visible fork history contains no Yashas-authored commit; the record does not claim an individual module contribution.",
