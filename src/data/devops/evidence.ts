...
export const evidence: EvidenceFact[] = [
  ...
  professional({
    ...
    claim: "Reduced overall deployment time by approximately 50% by parallelizing independent infrastructure while preserving ordered bring-up for dependent services.",
    shortClaim: "Approximately 50% deployment-time reduction",
    ...
    outcome: "Approximately 50% shorter overall deployment time.",
    status: "shipped",
  ...
  professional({
    ...
    claim: "Built a GitHub Actions workflow that generated and published Python and Java SDKs from OpenAPI contract changes, removing approximately four hours of routine manual effort per SDK.",
    ...
    outcome: "Routine generation and publication effort fell from about four hours per SDK to zero.",
    status: "shipped",
  ...
  professional({
    ...
    claim: "Reduced application page-load time by 40% by moving filtering closer to the database and correcting query behavior.",
    shortClaim: "40% page-load improvement",
    ...
    outcome: "40% faster page load with less unnecessary memory work.",
    status: "shipped",
