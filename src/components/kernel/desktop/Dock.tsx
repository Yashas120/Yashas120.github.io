...
export function Dock({
        ...
        {apps.map((a) => {
          ...
          return (
            <button
              ...
              className="flex min-w-[62px] flex-col items-center gap-0.5 rounded-lg px-2 py-1.5 transition-colors"
  ...
  return (
    ...
    >
      <div
        className="pointer-events-auto flex items-end gap-1 rounded-2xl border px-2 py-2 backdrop-blur win-shadow"
        ...
        {apps.map((a) => {
          ...
          return (
            <button
              key={a.id}
              onClick={() => onLaunch(a.id)}
              className="group relative flex h-10 w-10 items-center justify-center rounded-xl border transition-all hover:-translate-y-1"
              style={{
            ...
            >
              <Icon
                ...
                style={{ color: isOpen ? PHOSPHOR : "rgb(var(--zinc-400))" }}
              />
              <span
                className="pointer-events-none absolute -top-9 whitespace-nowrap rounded-md border px-2 py-1 font-mono text-[10px] opacity-0 transition-opacity group-hover:opacity-100"
                style={{
